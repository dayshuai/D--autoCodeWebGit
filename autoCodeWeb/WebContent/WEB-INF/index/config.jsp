...
<html>
	...
	<script>
		var columnsZh="序号,配置名称,配置Value,备注";
		var columnsEn="configId,configName,configValue,memo";	//对应的对象属性
		var columnsDb="configId,configName,configValue,memo";	//对应的数据库字段
		var isConvert=false;
							...
							<div class="col-xs-12">
								<form id="objectForm" method="post" onsubmit="return false;">
									...
									<div class="form-group col-xs-12">
										...
										<div class="col-xs-8">
											<textarea rows="5" cols="10" id="configValue" name="configValue" class="form-control" type="text"></textarea>
										</div>
									</div>
									<div class="form-group col-xs-12">
										<label class="col-xs-4 control-label">
										...
										<div class="col-xs-8">
											<textarea rows="5" cols="10" id="memo" name="memo" class="form-control" type="text"></textarea>
										</div>
									</div>
								</form>
							</div>
